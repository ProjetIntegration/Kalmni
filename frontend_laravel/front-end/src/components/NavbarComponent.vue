  ...
  <div class="max-w-screen-xl mb-20">
    ...
    <nav
      ...
      <div class="flex items-center justify-between w-full p-4">
        <img src="../assets/logo2.png" class="h-14 z-30" alt="kalmni Logo" />
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <img src="../assets/phone.png" class="pl-10" alt="" />
          <div class="pl-3">
            <p class="text-amber-400 font-bold">Appelez-nous</p>
            <p>(+255) 24 145 421</p>
          </div>
        </div>
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 -mr-10" id="navbar-sticky">
          <ul
            ...
            <li>
              <a href=""><router-link to="/ReserverService"
                  class="transition ease-in-out delay-150 block py-2 px-3 text-2xl text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-amber-500 md:p-0 md:light:hover:text-amber-500 light:text-white light:hover:bg-amber-500 light:hover:text-white md:light:hover:bg-transparent light:border-gray-700 hover:-translate-y-1 hover:scale-110 duration-300 ...">Reserver
                  un service</router-link></a>
            </li>
            <li class="text-gray-300">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-6 h-10"
                viewBox="0 0 24 24">
            ...
            <li>
              <a href=""><router-link to="/Acceuill"
                  class="transition ease-in-out delay-150 block py-2 px-3 text-2xl text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-amber-500 md:p-0 md:light:hover:text-amber-500 light:text-white light:hover:bg-amber-500 light:hover:text-white md:light:hover:bg-transparent light:border-gray-700 hover:-translate-y-1 hover:scale-110 duration-300 ...">Trouver
                  un prestatair</router-link></a>
            </li>

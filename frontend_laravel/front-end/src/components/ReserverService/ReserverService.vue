                        ...
                        <div class="flex  flex-col items-center">
                            <div class="relative mr-2">
                                ...
                                <input name="search" type="search" id="search" v-model="nom" @keyup="fetchServiceData()"
                                    ...
                                    <button
                              type="submit"
                              class="text-white justify-end mt-5 font-bold block w-300 p-4 text-center border border-gray-300 rounded-lg bg-amber-400 hover:bg-amber-500 focus:ring-4 focus:outline-none focus:ring-blue-300 text-sm dark:bg-amber-500 dark:hover:bg-amber-400 dark:focus:ring-amber-500"
                               >Chercher
                                </button>
                                </form>
                                </div>
                        ...
                        <div class="col-span-12 lg:col-span-10 detail w-full lg:pl-3">
                            <div class="flex items-center justify-between w-full mb-4">
                                <h5 class="font-manrope font-bold text-2xl leading-9 text-gray-900">
                                 {{ser.nom}}</h5>
                                 <h5 class="font-manrope font-bold text-2xl text-gray-900"> {{ ser.addresse }}</h5>
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <h6 class="text-indigo-600 font-manrope font-bold text-2xl leading-9 text-right">220 DT
                                </h6>
                            </div>
                        </div>
                    </div>
...
export default {
  ...
  methods: {
    fetchServiceData() {
      ...
      Service.Nom_Service(data2).then((res) => {

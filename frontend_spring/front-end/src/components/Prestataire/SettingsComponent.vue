                      ...
                      >
                        ...
                        <div class="mb-2">
                          ...
                          <input
                            ...
                            transition duration-300 ease-in-out file:-mx-3 file:-my-[0.32rem] file:overflow-hidden file:rounded-none file:border-0 file:border-solid file:border-inherit file:bg-neutral-100 file:px-3 file:py-[0.32rem]
                             file:text-neutral-700 file:transition file:duration-150 file:ease-in-out file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem] hover:file:bg-neutral-200 focus:border-primary focus:text-neutral-700 
                             focus:shadow-te-primary focus:outline-none dark:border-neutral-600 dark:text-neutral-200 dark:file:bg-neutral-700 dark:file:text-neutral-100 dark:focus:border-primary"
              ...
              <div class="space-y-12">
                ...
                <div class="border-b border-gray-900/10 pb-12">
                  ...
                  >
                    ...
                    <div>
                      <label class="text-sm mb-2 block" for="dob"
                        >Date de naissance</label
                      >
                      <div class="mt-2">
                        <input
                          class="bg-gray-100 text-sm px-4 py-3.5 rounded-md"
                          type="date"
                          id="dob"
                          required
                        />

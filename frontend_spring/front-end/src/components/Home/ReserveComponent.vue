<template>
  <div>
    ...
    <div class="flex flex-nowrap place-content-center space-x-8 ... p-20">
      ...
      >
        ...
        <div class="px-5 pb-5 mt-10">
          ...
          <div class="flex items-center justify-between">
            <a
              href="#"
              class="text-black mt-10 mb-5 justify-end font-bold block w-300 p-4 pl-10 pr-10 text-center border border-gray-300 rounded-lg bg-amber-400 hover:bg-amber-500 focus:ring-4 focus:outline-none focus:ring-blue-300 text-sm dark:bg-amber-500 dark:hover:bg-amber-400 dark:focus:ring-amber-500"
              >Réserver</a
            >
          </div>
        </div>
      ...
      <div
        class="w-full flex max-w-xl .. bg-white border border-gray-200 rounded-lg shadow-2xl dark:bg-gray-800 dark:border-gray-700"
      >
        <div class="pt-50 mb-5">
          <img

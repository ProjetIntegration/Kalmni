<template>
      ...
      <div class="mx-auto max-w-7xl py-8 sm:px-6">
        <div class="flex items-center gap-4">
          ...
          <form class="justify-end">
            <label
              for="default-search"
              class="mb-2 text-sm bg-amber-500 font-medium  sr-only dark:text-white"
              >Search</label
            >
            <div class="relative">
              <div
    ...
    <div class="divide-y-4 divide-slate-400/25 ...">
      ...
      <ul role="list" class="mx-auto max-w-7xl divide-y divide-dashed" v-if ="clients" v-for="(user,index) in clients " :key="index">
